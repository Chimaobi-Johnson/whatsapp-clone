...
const SidebarHeader = props => {
    ...
    const toggleOptionsMenu = () => {
        ...
        if(opMenu.style.transform === 'scale(0)') {
            opMenu.style.transform = 'scale(1)' 
        } else {
            opMenu.style.transform = 'scale(0)' 
        }
    ...
    return (
        <div className={styles.wrapper} style={{backgroundColor: theme.background.secondary}}>
            ...
            <div className={styles.buttonContainer} style={{color: theme.text.secondary}}>
                <div className={styles.statusButton}>
                    <svg id="df9d3429-f0ef-48b5-b5eb-f9d27b2deba6" viewBox="0 0 24 24" width="24" height="24" class="">
                ...
                <div className={styles.optionsButton} onClick={() => toggleOptionsMenu()}>
                    <div id="opMenu" className={styles.optionsMenu} style={{backgroundColor: theme.dropDown.background.primary, color: theme.dropDown.text.primary}}>
                        <ul>
                            <li>New group</li>
